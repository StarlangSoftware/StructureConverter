...
public class DependencyToConstituencyTest {
    ...
    public void testConvert() throws FileNotFoundException {
        ...
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(1));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0005.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(2));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0019.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(3));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0027.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(4));
        ...
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(6));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0096.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(7));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0179.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(8));
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0219.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(9));
