...
public class DependencyToConstituencyTest {
    ...
    public void testConvert() throws FileNotFoundException {
        ...
        ParseTree tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(0), ParserConverterType.BASIC_ORACLE);
        ...
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(1), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0005.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(2), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0019.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(3), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0027.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(4), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0041.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(5), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0059.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(6), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0096.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(7), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0179.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(8), ParserConverterType.BASIC_ORACLE);
        tree2 = new ParseTreeDrawable(new FileInputStream(new File("ConstituencyTrees/0219.train")));
        assertEquals(tree1.toString(), tree2.toString());
        tree1 = simpleDependencyToConstituencyTreeConverter.convert((AnnotatedSentence) annotated.getSentence(9), ParserConverterType.BASIC_ORACLE);
