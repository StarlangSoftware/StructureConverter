...
public class BasicDependencyOracle implements DependencyOracle {
    ...
    private ArrayList<Decision> setToAndAddUniversalDependency(int startIndex, int headIndex, ArrayList<WordNodePair> wordNodePairList, int finishIndex, ParseNodeDrawable parent) {
